...
<link href="pelicula/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- Custom Theme files -->
<link href="pelicula/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- Custom Theme files -->
<script src="js/pelicula/jquery.min.js"></script>
<!-- Custom Theme files -->
...
<body>
	...
	<div class="footer">
		...
		<script type="text/javascript" src="js/pelicula/jquery.flexisel.js"></script>
