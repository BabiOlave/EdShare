...
<head>
    ...
    <title></title>
    {!!Html::style('pelicula/bootstrap.min.css')!!}
    {!!Html::style('pelicula/metisMenu.min.css')!!}
    {!!Html::style('pelicula/sb-admin-2.css')!!}
    {!!Html::style('pelicula/font-awesome.min.css')!!}
</head>
...
<body>
    ...
    {!!Html::script('js/pelicula/jquery.min.js')!!}
    {!!Html::script('js/pelicula/bootstrap.min.js')!!}
    {!!Html::script('js/pelicula/metisMenu.min.js')!!}
    {!!Html::script('js/pelicula/sb-admin-2.js')!!}
